...
import { Uploader } from '@/utlis/uploadthing';
        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 p-8">
            ...
            <Link href='/auth/login'>
              <button className='my-6 hover:text-gray-300 bg-yellow-600 py-2 px-4 rounded-lg'>Order now</button>
